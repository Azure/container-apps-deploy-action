...
| `containerAppEnvironmentResourceGroup` | No       | The name of the Resource Group that contains the Azure Container App environment to use with the application. If not provided, it will fall back to the valie of resourceGroup, which defaults to `<container-app-name>-env`. |
