...
| `dockerfileBuildArguments`          | No       | A list of build argument(s) that is provided to the `docker build` command when a `Dockerfile` is provided. Space-separated values in 'key=value'.|
